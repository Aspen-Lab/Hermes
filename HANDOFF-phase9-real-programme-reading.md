...
| P9.3 | Programme-page discovery for events (one extra page, never more) | DONE | `cd web && npx vitest run src/lib/opportunities/page-text.test.ts` — PASS (1 file, 8 tests) |
