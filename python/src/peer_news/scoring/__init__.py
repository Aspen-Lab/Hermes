...
from peer_news.models import ScoredItem, TaggedItem
...
class CompositeScorer:
    ...
    def __init__(self, config: PeerConfig) -> None:
        ...
        from peer_news.scoring.keyword import KeywordScorer
        from peer_news.scoring.tfidf import TFIDFScorer
        from peer_news.scoring.source_priority import SourcePriorityScorer
