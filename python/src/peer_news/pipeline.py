...
from peer_news.models import Item, ScoredItem
from peer_news.output import get_writer
from peer_news.scoring import CompositeScorer
from peer_news.sources import get_source_registry
from peer_news.storage import Database
from peer_news.tagging import Tagger

log = logging.getLogger(__name__)


async def run_pipeline(config: PeerConfig, db: Database) -> list[ScoredItem]:
    """Single execution of the full Peer pipeline."""
...
async def _fetch_all(config: PeerConfig) -> list[Item]:
