...
export async function GithubStars() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline text-caption font-medium text-text-muted group-hover:text-heading transition-colors">
        Star
      </span>
      <span className="inline-flex items-center gap-0.5 text-meta tabular-nums text-accent font-semibold">
