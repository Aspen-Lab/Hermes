...
| P4.4 | The same controls on the job and event reports | DONE | `cd web && npx vitest run && npx tsc --noEmit` — 60 files, 510 tests passed; 1 live benchmark skipped per §4; independent report controls covered; typecheck clean |
...
| P6.3 | Jobs filters: Where, When, Role type, Visa | IN_PROGRESS | |
