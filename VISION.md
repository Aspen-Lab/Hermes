...
## How to apply this — the three checks

Before merging any change, ask:

1. **Information gap** — Does it close a gap the user would otherwise have to chase manually?
2. **Sustained learning** — Does it support growth over weeks, not just reaction to today's headlines?
3. **Calm precision** — Is it distilled and confident, never noisy or overwhelming?

### Reject changes that

- Pile on *more* information instead of refining it
- Add notification noise, gamification spikes, or doomscroll patterns
- Make the UI busier without sharpening the **signal**
- Optimize for engagement minutes rather than morning-ritual stickiness

### Favor changes that

- Cut, summarize, or prioritize
- Make the daily briefing feel inevitable and pleasant
- Help the user learn a topic over weeks
- Preserve the weather-forecast tone — short, confident, useful

---

## Original vision (founder's words)
...
>
> 3. 这个app必须是非常舒适简洁的，对信息进行精炼提纯的。它要像天气预报一样，给出的信息简单但是精准，需要最终让用户产生一种"每天早上开始工作第一件事看看这个app"的粘性。最终，这个app需要向是career/work/research/knowledge wise的一个天气预报，舒适精准简洁地让用户始终处于他们想了解的行业的信息前沿
